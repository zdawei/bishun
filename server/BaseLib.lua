...
--print("shu is ok")
	...
	if(angel > 22)then
		return false
	elseif(angel > 4.4 and angel <= 12.7 and curve> 2.12)then
		return false
	end
	...
	if(bl == 1)then
		if(angel > 12.7 and angel <= 22)then
			return true
		elseif(angel <= 12.7 and curve <= 2.12)then
			return true
		else
			return false
		end
...
function  IsPie(bh,bl)--撇
	...
	local a,b,c = line[1],line[2],line[3]
	local dis = Cal_Point2LineDis(fpt,a,b,c)
	if (Point2LineDown(fpt,line) == true and dis > 20) then
		--print("dis"..dis)
		return false
	end
	...
	if (bl == 1 )then
		if(curve <= 2.46 and curve > 1)then--化
			return true
		else
			return false
		end
...
function  IsNa(bh,bl)--捺
   ...
   currentBH.inflection = infle
	...
	local a,b,c = line[1],line[2],line[3]
	local dis = Cal_Point2LineDis(fpt,a,b,c)
	if (Point2LineUp(fpt,line) == true and dis > 20) then
		--print("dis"..dis)
		return false
	end
	...
	if(curve > 2.5)then
		return false
	elseif(curve <= 2.02 and angel <= 10.5)then
		return false
	end
	if (bl == 1 )then
		if(curve <= 2.02 and angel >10.5)then
			return true
		elseif(curve <= 2.2 and curve > 1.01)then
			return true
		else
			return false
		end
...
function IsHengGou(bh,bl)--横钩
	...
	if(angel0 > 7.4)then
		return false
	elseif(angel0 <= 7.4 and scale > 1)then
		return false
	...
	if( bl == 1)then
		if(angel0 <= 7.4 and scale > 0.65 and scale <= 1)then
			return true
		elseif(angel0 <= -10.9 and scale <= 0.65 and wanqu0 <= 1.1)then
			return true
...
function IsHengZheWanGou(bh,bl)--横折弯钩
	local startpt,startindex = GetStartPoint(bh)
	local endpt,endindex = GetEndPoint(bh)
...
function IsXieWanGou(bh,bl)--斜弯钩
	...
	--print("turning_index_1"..turning_index_1)
...
function	IsHengZheZheZheGou(bh,bl)--横折折折钩
	...
	--print("rightest_index"..rightest_index)
	--print("turning_index_3"..turning_index_3)
	...
	for i = 1, endindex do
		...
		local curDis = GetDistance(curPt,cmpPt1)
		if(curDis < tmpDis) then
			--if(curPt.y-cmpPt1.y>10 or cmpPt1.y-curPt.y>10)then
				tmpDis = curDis
				rightUp_index = i
				rightUp_pt = bh.ptSet[i]
			end
	...
	if(angel1 > 38 or wanqu23 > 3.6)then
		return false
	elseif(angel1 <= 32.6 and angel0 <= -32.6)then
		return false
	end
	if(bl == 1)then

		if(angel1 <= 32.6 and angel0 > -32.6 )then
--print(angel1)
	--print(angel0)
			return true
		elseif(angel1 > 32.6 and angel1 <= 38)then
